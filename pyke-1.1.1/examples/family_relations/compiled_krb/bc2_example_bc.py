                ...
                with engine.prove(rule.rule_base.root_name, 'child_parent', context,
                    ...
                    for x_1 in gen_1:
                        ...
                        if rule.pattern(5).match_data(context, context,
                                                      add_prefix(context.lookup_data('prefix'),
                                                                 context.lookup_data('p1_type'),
                                                                 context.lookup_data('p2_type'))):
                            context.end_save_all_undo()
                            rule.rule_base.num_bc_rule_successes += 1
                            yield
                        else:
...
def populate(engine):
    ...
    bc_rule.bc_rule('how_related_removed_cousins', This_rule_base, 'how_related',
                    ...
                    (contexts.variable('removed_cousin1'),
                     contexts.variable('cousin2'),
                     pattern.pattern_tuple((contexts.variable('nth'), pattern.pattern_literal('cousins'),
                                            contexts.variable('r1'), pattern.pattern_literal('removed'),), None),),
                    (),
                    (contexts.variable('removed_cousin1'),
                     contexts.variable('cousin1'),
