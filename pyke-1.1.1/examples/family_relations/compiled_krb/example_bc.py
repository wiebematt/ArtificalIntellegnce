                            ...
                            for x_2 in gen_2:
                                ...
                                if not rule.pattern(5).match_data(context, context, x_2):
                                    raise AssertionError(
                                        "example.how_related_child_parent: plan match to $plan#2 failed in when clause 2")
                                context.end_save_all_undo()
                                rule.rule_base.num_bc_rule_successes += 1
                                yield context
                    ...
                    for x_1 in gen_1:
                        ...
                        with engine.prove(rule.rule_base.root_name, 'add_prefix', context,
                            ...
                            for x_2 in gen_2:
                                ...
                                if not rule.pattern(5).match_data(context, context, x_2):
                                    raise AssertionError(
                                        "example.how_related_parent_child: plan match to $plan#2 failed in when clause 2")
                                context.end_save_all_undo()
                                rule.rule_base.num_bc_rule_successes += 1
                                yield context
                                context.undo_to_mark(mark2)
                    ...
                    for x_1 in gen_1:
                        ...
                        with engine.prove(rule.rule_base.root_name, 'add_prefix', context,
                            ...
                            for x_2 in gen_2:
                                ...
                                if not rule.pattern(5).match_data(context, context, x_2):
                                    raise AssertionError(
                                        "example.how_related_nn_au: plan match to $plan#2 failed in when clause 2")
                                context.end_save_all_undo()
                                rule.rule_base.num_bc_rule_successes += 1
                                yield context
                                context.undo_to_mark(mark2)
                    ...
                    for x_1 in gen_1:
                        ...
                        with engine.prove(rule.rule_base.root_name, 'add_prefix', context,
                            ...
                            for x_2 in gen_2:
                                ...
                                if not rule.pattern(5).match_data(context, context, x_2):
                                    raise AssertionError(
                                        "example.how_related_au_nn: plan match to $plan#2 failed in when clause 2")
                                context.end_save_all_undo()
                                rule.rule_base.num_bc_rule_successes += 1
                                yield context
                                context.undo_to_mark(mark2)
                        ...
                        with engine.prove(rule.rule_base.root_name, 'nth_cousin', context,
                            ...
                            for x_2 in gen_2:
                                ...
                                if not rule.pattern(3).match_data(context, context, x_2):
                                    raise AssertionError(
                                        "example.how_related_cousins: plan match to $plan#2 failed in when clause 2")
                                context.end_save_all_undo()
                                rule.rule_base.num_bc_rule_successes += 1
                                yield context
                                context.undo_to_mark(mark2)
                                ...
                                with engine.prove(rule.rule_base.root_name, 'nth_cousin', context,
                                    ...
                                    for x_3 in gen_3:
                                        ...
                                        if not rule.pattern(6).match_data(context, context, x_3):
                                            raise AssertionError(
                                                "example.how_related_removed_cousins: plan match to $plan#3 failed in when clause 3")
                                        context.end_save_all_undo()
                                        mark4 = context.mark(True)
                            ...
                            for x_2 in gen_2:
                                ...
                                with engine.prove(rule.rule_base.root_name, 'nth_cousin', context,
                                    ...
                                    for x_3 in gen_3:
                                        ...
                                        if not rule.pattern(6).match_data(context, context, x_3):
                                            raise AssertionError(
                                                "example.how_related_cousins_removed: plan match to $plan#3 failed in when clause 3")
                                        context.end_save_all_undo()
                                        mark4 = context.mark(True)
                                        if rule.pattern(7).match_data(context, context,
                                                                      len(context.lookup_data('grand')) + 1):
...
def populate(engine):
    ...
    bc_rule.bc_rule('great_grand_parent_and_child', This_rule_base, 'child_parent',
                    ...
                    (contexts.variable('child'),
                     contexts.variable('grand_parent'),
                     pattern.pattern_tuple((pattern.pattern_literal('great'), contexts.variable('a'),),
                                           contexts.variable('b')),
                     contexts.variable('parent_type'),
                     contexts.variable('child_type'),),
                    (),
